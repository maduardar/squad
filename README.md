...
Код написан для Python3.6
* Для начала, установите все необходимые пакеты, описанные в [requirements.txt](https://github.com/maduardar/squad/blob/master/requirements.txt)
...
``` 
 *Hint: Если у Вас есть уже скачанный `glove.840B.300d.txt`, положите его в папку Data –– это ускорит процеесс.*
* Для обучения: 
```
